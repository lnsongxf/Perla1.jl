...
\begin{equation}
\begin{aligned}
y(a, p, p_{-i}) &=  \overline{\Gamma}^{1 - \kappa} \Omega q_k^{\kappa-1} p_i^{-1/\sigma-1} \dfrac{1}{N} \cdot \\ &\sum_{ n_K \in N_K, n_K^k > 0 } n^k_K f_{n_K}(a) \Bigg[ \sum_{k' \neq k } n_K^{k'} \left( \dfrac{q_k}{q_{k'}} p_{k'} \right)^{-1/\sigma} +   
 p_i^{-1/\sigma} +   (n_K^k-1) p^{-1/\sigma}_{k}  \Bigg]^{\sigma(\kappa-1) -1} \\ 
  &=  \overline{\Gamma}^{1 - \kappa} \Omega q_k^{\kappa-1} p_i^{-1/\sigma-1} \dfrac{1}{N} \cdot  \\
 & \sum_{ n_K \in N_K, n_K^k > 0 } n^k_K f_{n_K}(a) \Bigg[ \sum_{k' \neq k } n_K^{k'} \left( \dfrac{q_k}{q_{k'}} p_{k'} \right)^{-1/\sigma} +   
 p_i^{-1/\sigma} +   (n_K^k-1) p^{-1/\sigma}_{k}  \Bigg]^{\sigma(\kappa-1) -1}
\end{aligned}
\end{equation}
