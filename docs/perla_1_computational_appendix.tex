...
\label{eq:full-total-demand-multiple-cohorts-alternative}
\end{align}
...
\right)  
\end{align}
which is equivalent with \eqref{eq:full-total-demand-multiple-cohorts-alternative} by taking $N = N_H$, $p_b = p_H$, and $q_b = q_H$.
